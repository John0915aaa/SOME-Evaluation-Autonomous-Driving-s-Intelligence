...
class IntersectionDetector:
    ...
    def __init__(self, agent_states, all_timesteps, column_dict, all_agents, move_agent, map_processed_data):
        ...
        (
            ...
            self.all_agents,
            self.move_agent,
            self.map_processed_data,
        ) = (agent_states, all_timesteps, column_dict, all_agents, move_agent, map_processed_data)
