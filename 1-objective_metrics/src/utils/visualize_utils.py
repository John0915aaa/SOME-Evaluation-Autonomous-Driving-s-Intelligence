...
def plot_agent_trajectory(agent_id, interact_ids, all_agents, agent_states, timestamp_index, all_timesteps, dt,
                          ...
                          considertime, ego_index, key_agent_index):
    """
...
def draw_pic(desired_scene, all_agents, all_timesteps, dataset, id_rawid, raw_scene_id, interact_ids, timestamp, start, end, dt, considertime, ego_index, key_agent_index, index, save_path='./'):
    """
    ...
    for agent_id in current_ids:
        plot_agent_trajectory(
            ...
            lane_kd_tree, scene_cache, agent_lane_ids, considertime, ego_index, key_agent_index
        )
